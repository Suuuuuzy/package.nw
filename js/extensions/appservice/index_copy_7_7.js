            ...
            5082: (e, t, o) => {
                ...
                e.exports = function() {
                    ...
                    function c(e, r, i) {
                        ...
                        // if ("openType" in r){ // openType can be: appLaunch, navigateTo |, redirectTo, reLaunch, switchTab?
                        //     console.log(r["openType"]);
                        //     // console.log(r["path"].__getTaint__()); // taint is 0, it's ok, we don't need to taint page path
                        // }
                        // if ("query" in r){
                        //     if ("fakeKey" in r["query"]){
                        //         r["query"]["fakeKey"].__setTaint__(__taintConstants__()['OnLaunch']);
                        //         console.log(r["query"]["fakeKey"].__getTaint__()); // taint is 1
                        //     }
                        // }
                        // if ("appLaunchInfo" in r){
                        //         r["appLaunchInfo"]["query"]["fakeKey"] = 'fakeValue';
                        //         r["appLaunchInfo"]["query"]["fakeKey"].__setTaint__(__taintConstants__()['OnLaunch']);
                        // }
                        // yjj end
                        }
                        const a = t[e];
