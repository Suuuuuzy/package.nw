...
export declare function insertCharsWithinNodes<CTOR extends (ArrayBuffer | SharedArrayBuffer)>(nodes: BufferedTextDocumentModelNode[], originalChunkSlot: CTOR | undefined, lastChunkIndex: number, lastChunkWriteOffset: number, beforeCharOffset: number, chars: string, ctor: {
    new (len: number): CTOR;
}): {
    newlyChunks: CTOR[];
    lastOffset: number;
