...
function resolveImplicitName(parentName) {
    ...
    return elementMap[parentName]
        ...
        || (inlineElements.has(parentName) ? 'text' : 'view');
}
...
var html$1 = {
	...
	"style": "style",
	// "script": "script", // not in wxml
	// "script:src": "script[src]", // not in wxml
	"img": "img[src alt]/",
	...
	// "form:post": "form[method=post]", // diffrent in wxml
	"label": "label[for]",
	...
	// "textarea": "textarea[name=${1} id=${1} cols=${2:30} rows=${3:10}]", // in wxml textarea is different
	"marquee": "marquee[behavior direction]",
	"menu:c|menu:context": "menu[type=context]",
	"menu:t|menu:toolbar": "menu[type=toolbar]",
	// "video": "video[src]", // in wxml video is inline element
	"audio": "audio[src]",
  ...
  "share-element": "share-element[key=${0}]{\n\t${1}\n}",
  "swiper": "swiper{\n\t${0}\n}",
  "swiper-item": "swiper-item{\n\t${0}\n}",
  "v": "view{\n\t${0}\n}",
  "icon": "icon[type]/",
  "progress": "progress/",
  "rich-text": "rich-text[nodes=${0}]/",
  "checkbox": "checkbox[value=${0}]/",
  "checkbox-group": "checkbox-group[bindchange=${0}]{\n\t${1}\n}",
  "form": "form[bindsubmit=${0}]{\n\t${1}\n}",
  "keyboard-accessory": "keyboard-accessory{\n\t${0}\n}",
  "picker": "picker[mode]{\n\t\n}",
  "picker-view": "picker-view{\n\t${0}\n}",
  "radio": "radio[value=${0}]/",
  "radio-group": "radio-group[bindchange=${0}]{\n\t${1}\n}",
  "slider": "slider[bindchange=${0}]/",
  "switch": "switch[checked=${0} bindchange=${1}]/",
  "textarea": "textarea[value=${0}]/",
  "functional-page-navigator": "functional-page-navigator[name=${0}]{\n\t${1}\n}",
  "navigator": "navigator[url=${0}]",
  "camera": "camera[mode=${normal}]/",
	"channel-video": "channel-video[feed-id=${0} finder-user-name=${1}]/",
	"grid-view": "grid-view[type=${0}]",
	"channel-live": "channel-live[feed-id=${0} finder-user-name=${1}]",
  "image": "image[src mode]/",
  "live-player": "live-player[src]/",
  "live-pusher": "live-pusher[url]/",
  "video": "video[src]/",
  "voip-room": "voip-room[openid=${0}]/",
  "map": "map[longitude=${0} latitude=${1}]/",
  "canvas": "canvas[type=${0} id=${1}]/",
  "ad": "ad[unit-id=${0}]/",
  "ad-custom": "ad-custom[unit-id=${0}]/",
  "official-account": "official-account/",
  "web-view": "web-view[src]/",
  "block": "block{\n\t${0}\n}",
  "template:is": "template[is=${0} data]/",
  "template:name": "template[name=${0}]{\n\t${1}\n}",
  "import": "import[src]/",
  "wxs:module": "wxs[module=${1}]{\n\t${1}\n}",
  "wxs:src": "wxs[src=${0} module=${1}]/",
  /// ---------- wxml -------------- ///
};
