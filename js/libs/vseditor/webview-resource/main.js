...
//! active-frame allow-top-navigation
/*---------------------------------------------------------------------------------------------
...
(function() {
  ...
  function createWebviewManager(host) {
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      host.onMessage('content', async (_event, data) => {
        ...
        //! sandbox
        const sb = function(s) {
          return s + ' allow-top-navigation allow-top-navigation-by-user-activation'
        }
        newFrame.setAttribute('sandbox', sb(options.allowScripts ? 'allow-scripts allow-forms allow-same-origin' : 'allow-same-origin'));
        if (host.fakeLoad) {
  ...
  if (typeof module !== 'undefined') {
    module.exports = createWebviewManager,( /** @type {any} */ (window)).createWebviewManager = createWebviewManager;
  } else {
