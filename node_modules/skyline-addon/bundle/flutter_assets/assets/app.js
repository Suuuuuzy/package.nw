...
module.exports = function (modules) {
...
}, function (module, exports, __nested_webpack_require_57932__) {
  var FuncArr = __nested_webpack_require_57932__(3);
...
}, function (module, exports, __nested_webpack_require_67286__) {
  var LLParser = __nested_webpack_require_67286__(1);
...
}, function (module, exports, __nested_webpack_require_70913__) {
  var FuncArr = __nested_webpack_require_70913__(3);

  var globalOptions = __nested_webpack_require_70913__(4);

  var dataPath = __nested_webpack_require_70913__(7);
...
}, function (module, exports, __nested_webpack_require_83392__) {
  var FuncArr = __nested_webpack_require_83392__(3);

  var eventSystem = __nested_webpack_require_83392__(6);

  var Observer = __nested_webpack_require_83392__(10);

  var ClassList = __nested_webpack_require_83392__(11);

  var TextNode = __nested_webpack_require_83392__(12);

  var FakeDomElement = __nested_webpack_require_83392__(14);

  var globalOptions = __nested_webpack_require_83392__(4);

  var globalState = __nested_webpack_require_83392__(13);
...
}, function (module, exports, __nested_webpack_require_132658__) {
  var FuncArr = __nested_webpack_require_132658__(3);
...
}, function (module, exports, __nested_webpack_require_135706__) {
  var globalOptions = __nested_webpack_require_135706__(4);
...
}, function (module, exports, __nested_webpack_require_144617__) {
  var Observer = __nested_webpack_require_144617__(10);

  var globalOptions = __nested_webpack_require_144617__(4);

  var globalState = __nested_webpack_require_144617__(13);
...
}, function (module, exports, __nested_webpack_require_149275__) {
  var FuncArr = __nested_webpack_require_149275__(3);

  var dataUtils = __nested_webpack_require_149275__(5);

  var DataGroup = __nested_webpack_require_149275__(16);

  var eventSystem = __nested_webpack_require_149275__(6);

  var Behavior = __nested_webpack_require_149275__(8);

  var Element = __nested_webpack_require_149275__(9);

  var NativeNode = __nested_webpack_require_149275__(17);

  var Observer = __nested_webpack_require_149275__(10);

  var ClassList = __nested_webpack_require_149275__(11);

  var FakeDomElement = __nested_webpack_require_149275__(14);

  var globalOptions = __nested_webpack_require_149275__(4);

  var globalState = __nested_webpack_require_149275__(13);

  var dataPath = __nested_webpack_require_149275__(7);
  ...
  Component.createWithGenericsAndContext = function (tagName, compDef, genericImpls, backendContext, templateOptions) {
    ...
    if (tagName) {
      if (tagName.indexOf('-') < 0 && !compDef || globalOptions.extraNativeNodeTags.includes(tagName)) {
...
}, function (module, exports, __nested_webpack_require_185174__) {
  var FuncArr = __nested_webpack_require_185174__(3);

  var dataUtils = __nested_webpack_require_185174__(5);
...
}, function (module, exports, __nested_webpack_require_197893__) {
  var Element = __nested_webpack_require_197893__(9);

  var ClassList = __nested_webpack_require_197893__(11);

  var FakeDomElement = __nested_webpack_require_197893__(14);

  var globalOptions = __nested_webpack_require_197893__(4);

  var globalState = __nested_webpack_require_197893__(13);
...
}, function (module, exports, __nested_webpack_require_202290__) {
  var Element = __nested_webpack_require_202290__(9);

  var globalOptions = __nested_webpack_require_202290__(4);
...
}, function (module, exports, __nested_webpack_require_203699__) {
  var Element = __nested_webpack_require_203699__(9);

  var Component = __nested_webpack_require_203699__(15);

  var VirtualNode = __nested_webpack_require_203699__(18);

  var NativeNode = __nested_webpack_require_203699__(17);

  var TextNode = __nested_webpack_require_203699__(12);

  var globalOptions = __nested_webpack_require_203699__(4);
  ...
  ShadowRoot.prototype.createComponent = function (tagName, compName, genericImpls, templateOptions) {
    if (globalOptions.extraNativeNodeTags.includes(tagName)) {
...
}, function (module, exports, __nested_webpack_require_209472__) {
  var Element = __nested_webpack_require_209472__(9);

  var TextNode = __nested_webpack_require_209472__(12);
...
}, function (module, exports, __nested_webpack_require_212009__) {
  var globalOptions = __nested_webpack_require_212009__(4);

  var FuncArr = __nested_webpack_require_212009__(3);
...
var hover = {
  ...
  attached: function () {
    ...
    console.error('@@@ context ', this.getBackendContext());
  },
  detached: function () {
    this.unbindHover();
  },
      ...
      if (this.hoverClass === 'none' || this.disabled) {} else {
        ...
        this._hoverStyleTimeId = setTimeout(function () {
          ...
          if (_this._defaultHoverClass) {
            ...
            _this.getBackendContext().startRender();
          ...
          _this.getBackendContext().startRender(function () {});
        }, this.hoverStartTime);
      }
    },
    ...
    _hoverReset: function () {
      if (this._hovering) {
        ...
        if (this.hoverClass === 'none') {} else if (this._defaultHoverClass) {
          console.info('hover toggle _defaultHoverClass');
          this.classList.toggle(this._defaultHoverClass, false);
          this.getBackendContext().startRender();
        ...
        this.getBackendContext().startRender(function () {});
      }
    }
  }
};
...
/* harmony import */ var _size_normalizer__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./size-normalizer */ "./src/behaviors/size-normalizer.ts");
...
function registerBuiltinBehaviors(exparser) {
  ...
  exparser.registerBehavior(_size_normalizer__WEBPACK_IMPORTED_MODULE_9__.default);
}
...
var native = {
  ...
  detached: function () {},
  methods: {
    _delay: function (method, newVal, oldVal) {
      this._deferred.push({
        callback: method,
        args: [newVal, oldVal]
      });
...
/***/ "./src/behaviors/size-normalizer.ts":
/*!******************************************!*\
  !*** ./src/behaviors/size-normalizer.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var sizeNormalizer = {
  ...
  methods: {
    ...
    normalizeSizeStr: function (value) {
      if (typeof value === 'number' || parseFloat(value, 10).toString() === value) {
        return value + 'px';
      }

      if (isRpxString(value)) return wx.transformRpx('%%?' + value + '?%%');
      return value;
    },
    normalizeSizeInPlace: function (object, path) {
      var _this = this;

      var _normalize = function (_key) {
        var val = object[_key];

        if (typeof val === 'string') {
          object[_key] = _this.normalizeSize(val);
        }
      };

      if (Object.prototype.toString.call(path) === '[object Array]') {
        path.forEach(_normalize);
...
/* harmony default export */ __webpack_exports__["default"] = (sizeNormalizer);
...
/* harmony import */ var _components_worklet_event_handler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/worklet_event_handler */ "./src/components/worklet_event_handler.ts");
...
var workletHandler = {
  ...
  methods: {
    attachNativeEvents: function () {
      ...
      return function attachNativeEvents() {
    ...
    obtainWorkletFunc: function () {
      var _ref2 = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()(function* (methodName) {
        if (!methodName) return null;
        var host = this.ownerShadowRoot.getHostNode();
        var domain = _lib_exparser__WEBPACK_IMPORTED_MODULE_1___default().Component.getComponentOptions(host).domain;

        if (domain === '//') {
          var caller = _lib_exparser__WEBPACK_IMPORTED_MODULE_1___default().Element.getMethodCaller(host);
          var workletFactory = caller[`_${methodName}_worklet_factory_`];
          if (typeof workletFactory !== 'function') return null;
          var worklet = workletFactory.call(host);
          if (typeof worklet !== 'function') return null;
          return worklet;
        } else {
          var pageId = this.getPageId();
          var workletId = yield __virtualDOM__.getWorkletIdByName(host, methodName, pageId);

          if (typeof workletId === 'number') {
            var _worklet = SkylineGlobal.Runtime.getJsValueById(workletId);

            SkylineGlobal.Runtime.unRegisterJsValue(workletId);
            if (typeof _worklet !== 'function') return null;
            return _worklet;
          }
      ...
      return function obtainWorkletFunc(_x) {
        return _ref2.apply(this, arguments);
      };
    }(),
    addWorkeltEventHandler: function (eventName, worklet, tag) {
      if (typeof worklet !== 'function') return;
      var handler = new _components_worklet_event_handler__WEBPACK_IMPORTED_MODULE_2__.default(worklet, eventName);
      handler.register(tag);
...
(0,_bridge__WEBPACK_IMPORTED_MODULE_1__.subscribe)('operateMap', function (res, pageId) {
  triggerEvent(pageId, 'operateMap', res, {
    bubbles: true
  });
});
...
/* harmony import */ var _wx_cover_image__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./wx-cover-image */ "./src/components/wx-cover-image/index.ts");
/* harmony import */ var _wx_scroll_view__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./wx-scroll-view */ "./src/components/wx-scroll-view/index.ts");
/* harmony import */ var _wx_map__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./wx-map */ "./src/components/wx-map/index.ts");
/* harmony import */ var _wx_video__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./wx-video */ "./src/components/wx-video/index.ts");
/* harmony import */ var _wx_button__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./wx-button */ "./src/components/wx-button/index.ts");
/* harmony import */ var _wx_navigator__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./wx-navigator */ "./src/components/wx-navigator/index.ts");
/* harmony import */ var _wx_voip_room__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./wx-voip-room */ "./src/components/wx-voip-room/index.ts");
/* harmony import */ var _wx_canvas__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./wx-canvas */ "./src/components/wx-canvas/index.ts");
/* harmony import */ var _wx_input__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./wx-input */ "./src/components/wx-input/index.ts");
/* harmony import */ var _wx_hero__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./wx-hero */ "./src/components/wx-hero/index.ts");
/* harmony import */ var _wx_swiper__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./wx-swiper */ "./src/components/wx-swiper/index.ts");
/* harmony import */ var _wx_swiper_item__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./wx-swiper/item */ "./src/components/wx-swiper/item.ts");
/* harmony import */ var _wx_textarea__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./wx-textarea */ "./src/components/wx-textarea/index.ts");
/* harmony import */ var _events__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./events */ "./src/components/events/index.ts");
/* harmony import */ var _wx_gesture__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./wx-gesture */ "./src/components/wx-gesture/index.ts");
/* harmony import */ var _components_less__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./components.less */ "./src/components/components.less");
/* harmony import */ var _components_dark_less__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./components-dark.less */ "./src/components/components-dark.less");
/* harmony import */ var _components_v2_less__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./components-v2.less */ "./src/components/components-v2.less");
/* harmony import */ var _components_v2_dark_less__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./components-v2-dark.less */ "./src/components/components-v2-dark.less");
...
var tagsCreatedAsNativeNode = ['wx-view', 'wx-text', 'wx-cover-view'];
function registerBuiltinComponents(exparser, runtime) {
  if (true) {
    runtime.appendGlobalStylesheet(_components_less__WEBPACK_IMPORTED_MODULE_16__.default);
  }

  exparser.globalOptions.extraNativeNodeTags = exparser.globalOptions.extraNativeNodeTags || [];
  exparser.globalOptions.extraNativeNodeTags.push(...tagsCreatedAsNativeNode);
  exparser.registerElement(_wx_button__WEBPACK_IMPORTED_MODULE_5__.default);
  exparser.registerElement(_wx_image__WEBPACK_IMPORTED_MODULE_0__.default);
  exparser.registerElement(_wx_cover_image__WEBPACK_IMPORTED_MODULE_1__.default);
  exparser.registerElement(_wx_scroll_view__WEBPACK_IMPORTED_MODULE_2__.default);
  exparser.registerElement(_wx_map__WEBPACK_IMPORTED_MODULE_3__.default);
  exparser.registerElement(_wx_video__WEBPACK_IMPORTED_MODULE_4__.default);
  exparser.registerElement(_wx_navigator__WEBPACK_IMPORTED_MODULE_6__.default);
  exparser.registerElement(_wx_voip_room__WEBPACK_IMPORTED_MODULE_7__.default);
  exparser.registerElement(_wx_canvas__WEBPACK_IMPORTED_MODULE_8__.default);
  exparser.registerElement(_wx_input__WEBPACK_IMPORTED_MODULE_9__.default);
  exparser.registerElement(_wx_hero__WEBPACK_IMPORTED_MODULE_10__.default);
  exparser.registerElement(_wx_swiper__WEBPACK_IMPORTED_MODULE_11__.default);
  exparser.registerElement(_wx_swiper_item__WEBPACK_IMPORTED_MODULE_12__.default);
  exparser.registerElement(_wx_textarea__WEBPACK_IMPORTED_MODULE_13__.default);
  _wx_gesture__WEBPACK_IMPORTED_MODULE_15__.default.forEach(function (handler) {
...
/***/ "./src/components/wx-cover-image/index.ts":
/*!************************************************!*\
  !*** ./src/components/wx-cover-image/index.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var coverImage = Object.assign({}, _wx_image__WEBPACK_IMPORTED_MODULE_0__.default);
coverImage.is = 'wx-cover-image';
...
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ "./node_modules/@babel/runtime/helpers/asyncToGenerator.js");
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _reanimated_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../reanimated/core */ "./src/reanimated/core.ts");
/* harmony import */ var _utils_virtual_node__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/virtual-node */ "./src/components/utils/virtual-node.ts");
/* harmony import */ var _utils_emitter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../utils/emitter */ "./src/utils/emitter.ts");
...
var handlerTag = 1;
var handlerIDToTag = {};
var handlerEmitter = (0,_utils_emitter__WEBPACK_IMPORTED_MODULE_3__.createManyEmitter)();
  ...
  var option = {
    ...
    lifetimes: {
      ...
      attached: function () {
        ...
        var childNode = (0,_utils_virtual_node__WEBPACK_IMPORTED_MODULE_2__.findNonVirtualNode)(this);
    ...
    methods: {
      initDataSet: function () {
        ...
        this.shareableDataset = (0,_reanimated_core__WEBPACK_IMPORTED_MODULE_1__.makeMutable)(initialDataset);
      },
      ...
      attachNativeEvents: function () {
        var _ref = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()(function* () {
          ...
          nativeEvents.forEach( /*#__PURE__*/function () {
            var _ref2 = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()(function* (item) {
              var worklet = yield _this.obtainWorkletFunc(item.methodName);
              if (typeof worklet !== 'function') return;

              if (item.eventName === 'onGestureHandlerEvent') {
                var context = (0,_reanimated_core__WEBPACK_IMPORTED_MODULE_1__.makeRemote)({});
                ...
                var wrpWorklet = function () {
                  ...
                  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/components/wx-gesture/index.ts (263:31)";
                  _f.__worklet = true;
                  return _f;
                }();

                _this.addWorkeltEventHandler(item.eventName, wrpWorklet, _this.handlerTag);
              } else {
                _this.addWorkeltEventHandler(item.eventName, worklet, _this.handlerTag);
              }
            });
...
var MARKER_ID_INC = 900000000;
var LINE_ID_INC = 10000000;

function transformColor(color) {
  if (color === 'transparent') return '#00000000';
  if (!color || !/^#/.test(color) || color.length > 4) return color;
  var ans = color.split('').map(function (item) {
    return item + item;
  }).join('').slice(1);
  return ans;
}

function indexOf2(arr, id) {
  for (var i = 0; i < arr.length; i++) {
    var item = arr[i];
...
var map = {
      ...
      var T = {
        ...
        C: [{
          ...
          C: [{
            ...
            A: {
              "id": "calloutcontainer",
              "style": "position: absolute; top: 100%; left: 5000px;"
            },
            C: [{
              V: 5,
              N: "callout",
  ...
  behaviors: ['wx-base', 'wx-native', 'wx-positioning-target', 'wx-size-normalizer', 'wx-cloud'],
  options: {
    renderingMode: 'full',
    multipleSlots: true,
    lazyRegistration: true
  ...
  created: function () {
    this._box = {};
    this._mapId = this.viewId = this.getPositioningId();
    var methods = ['markertap', 'callouttap', 'labeltap', 'controltap', 'regionchange', 'tap', 'indoorchange', 'poitap', 'anchorpointtap'];
    this.bindMethod(methods);
    this._calloutMap = {};
    this._markers = [];
    this.updatingCustomCallout = false;
  ...
  attached: function () {
    ...
    this.$.map.$$.getBoundingClientRect(function (rect) {
      Object.assign(_this._box, rect);

      _this._insertNativeMap();
    });
  },
  detached: function () {
    var _this2 = this;
  ...
  methods: {
    ...
    _update: function (arg, tip, fn) {
      arg.mapId = this._mapId;
      arg.hide = this.hidden;

      if (typeof arg.layerStyle === 'number') {
        arg.styleId = arg.layerStyle;
      }

      arg.viewId = this.viewId;
      this.invoke('updateXWebMap', arg, function () {
    ...
    _transformMarkers: function (markers) {
      ...
      return (markers || []).map(function (marker) {
        var ret = {};
        if (!marker) return ret;
        Object.keys(marker).forEach(function (key) {
          if (Object.prototype.toString.call(marker[key]) === '[object Object]') {
            ret[key] = {};
            Object.keys(marker[key]).forEach(function (key2) {
              ret[key][key2] = marker[key][key2];
            });
          } else {
            ret[key] = marker[key];
          }
        ...
        _this3.normalizeSizeInPlace(ret, ['width', 'height']);

        if (typeof ret.alpha === 'number') {
          if (ret.alpha > 1) ret.alpha = 1;
          if (ret.alpha < 0) ret.alpha = 0;
        } else {
          ret.alpha = 1;
        }

        if (ret.label) {
          ret.label.fontSize = _this3.normalizeSize(ret.label.fontSize || 12);
          ret.label.bgColor = ret.label.bgColor || '#00000000';
          ret.label.bgColor = transformColor(ret.label.bgColor);
          ret.label.borderColor = transformColor(ret.label.borderColor);
          ret.label.color = transformColor(ret.label.color);
          ret.label.textAlign = ret.label.textAlign || 'right';

          _this3.normalizeSizeInPlace(ret.label, ['anchorX', 'anchorY', 'borderWidth', 'borderRadius', 'padding', 'width', 'height']);
        }

        if (ret.latitude > 90 || ret.latitude < -90) {
          console.warn(`markers.latitude 范围是 -90 ~ 90，markers.id: [${ret._id}]`);
        }

        if (ret.longitude > 180 || ret.longitude < -180) {
          console.warn(`markers.longitude 范围是 -180 ~ 180，markers.id: [${ret._id}]`);
        }

        ret.longitude = Number(ret.longitude);
        ret.latitude = Number(ret.latitude);
        ret.anchor = ret.anchor || {
          x: 0.5,
          y: 1
        };

        if (ret.customCallout) {
          ret.customCallout.viewId = _this3._calloutMap[ret.id] || -1;
          ret.customCallout.display = ret.customCallout.display === 'ALWAYS' ? 1 : 0;
          ret.customCallout.anchorX = ret.customCallout.anchorX || 0;
          ret.customCallout.anchorY = ret.customCallout.anchorY || 0;
          delete ret.callout;
          delete ret.title;
        } else if (ret.callout) {
          var shadow = (ret.callout.boxShadow || '').trim().split(/\s+/);

          if (shadow.length === 3) {
            ret.callout.shadowOffsetX = parseFloat(shadow[0]);
            ret.callout.shadowOffsetY = parseFloat(shadow[1]);

            if (IS_IOS) {
              ret.callout.shadowColor = shadow[2].substr(0, 7);
              ret.callout.shadowOpacity = Number('0x' + shadow[2].substr(7, 2)) / 255 || 1;
            } else {
              ret.callout.shadowColor = shadow[2];
            }
          } else {
            ret.callout.shadowColor = '#FFFFFF';
            ret.callout.shadowOpacity = 0;
          }

          _this3.normalizeSizeInPlace(ret.callout, ['fontSize', 'borderRadius', 'borderWidth', 'padding']);

          ret.callout.display = ret.callout.display === 'ALWAYS' ? 1 : 0;
          ret.callout.bgColor = ret.callout.bgColor || '#FFFFFF';
          ret.callout.bgColor = transformColor(ret.callout.bgColor);
          ret.callout.borderColor = transformColor(ret.callout.borderColor);
          ret.callout.color = transformColor(ret.callout.color);
          ret.callout.textAlign = ret.callout.textAlign || 'center';
          ret.callout.content = ret.callout.content || '';
          ret.callout.anchorX = ret.callout.anchorX || 0;
          ret.callout.anchorY = ret.callout.anchorY || 0;
          delete ret.title;
        } else if (ret.title) {
          ret.callout = {
            content: ret.title,
    ...
    _transformControls: function (controls) {
      var _this4 = this;
      ...
      return controls.map(function (control) {
        ...
        if (typeof control.id !== 'undefined' && _this4.bindcontroltap && control.clickable) {
          ret.data = JSON.stringify({
            controlId: control.id,
            bindcontroltap: _this4.bindcontroltap,
            target: {
              dataset: _this4.dataset,
              id: _this4.id,
              offsetTop: _this4.$$.offsetTop,
              offsetLeft: _this4.$$.offsetLeft
            },
            nodeId: _this4.getNodeId()
          });
        }
    ...
    _insertNativeMap: function () {
      ...
      Object.keys(this.setting).forEach(function (key) {
        _this5[key] = _this5.setting[key];
      });
      var pluginId = (this.getPluginId() || '').split('/')[0];
      var args = {
        parentId: 0,
        position: this._box,
        ...
        zIndex: 0,
        pluginId: this.usePluginId ? pluginId : ''
      };

      var callback = function () {
        _this5._ready();

        console.log(`pubilsh mapInsert ${_this5.id} ${_this5._mapId}`);

        _this5.publish('mapInsert', {
          domId: _this5.id,
          mapId: _this5._mapId,
          nodeId: _this5.getNodeId(),
          pluginId: _this5.getPluginId(),
          showLocation: _this5.showLocation,
          bindregionchange: _this5.bindregionchange,
          bindpoitap: _this5.bindpoitap,
          bindtap: _this5.bindtap,
          bindindoorchange: _this5.bindindoorchange,
          bindanchorpointtap: _this5.bindanchorpointtap,
          bindmarkertap: _this5.bindmarkertap,
          bindcallouttap: _this5.bindcallouttap,
          bindlabeltap: _this5.bindlabeltap,
          target: {
            id: _this5.id,
            dataset: _this5.dataset,
            offsetTop: 0,
            offsetLeft: 0
          }
        });

        var root = __virtualDOM__.getRootNode(_this5.getPageId());

        _this5._operateMapId = _runtime__WEBPACK_IMPORTED_MODULE_1__.default.getInstance().getExparser().addListenerToElement(root, 'operateMap', function (evt) {
          console.log('render operateMap ', evt.detail.mapId);
          var mapId = evt.detail.mapId;
          if (mapId !== _this5._mapId) return;

          _this5.operateMapHandler(evt.detail);
        });
      };
        ...
        case 'includeMapPoints':
          {
            this.invoke('includeMapPoints', {
              ...
              _this6.publish('operateMapCallback', {
                errMsg: res.errMsg,
                mapId: mapId,
                callbackId: callbackId,
                method: method
    ...
    latitudeChanged: function (newVal) {
      if (!newVal) {
        return;
      }
    ...
    longitudeChanged: function (newVal) {
      if (!newVal) {
        return;
      }
    ...
    scaleChanged: function (newVal = 16) {
      if (!newVal) {
        return;
      }
    ...
    minScaleChanged: function (newVal = 3) {
    ...
    maxScaleChanged: function (newVal = 22) {
      if (!this._isReady) return;
    ...
    coversChanged: function (newVal = [], oldVal) {
      if (!this._isReady) {
        this._delay('coversChanged', newVal, oldVal);
      ...
      this._update({
        centerLatitude: this.latitude,
        centerLongitude: this.longitude,
        covers: this._transformPath(newVal, window.__route__)
      }, '覆盖物');
    },
    markersChanged: function (newVal = [], oldVal = []) {
      var _this7 = this;

      if (!this._isReady) {
        this._delay('markersChanged', newVal, oldVal);

        return;
      }

      oldVal = this._oldMarkers || [];
      ...
      var removes = [];
      var exists = [];
      var markersIdMap = this._markersIdMap || {};
      this._markersIdMap = {};
      newVal = newVal.map(function (marker) {
        var item = {};
        Object.keys(marker).forEach(function (key) {
          item[key] = marker[key];
        });
        ...
        if (typeof item.id === 'undefined' || typeof item.id === 'string' || isNaN(Number(item.id))) {
          item.id = markersIdMap[item._id] || MARKER_ID_INC++;

          if (typeof item._id === 'string') {
            _this7._markersIdMap[item._id] = item.id;
          }
        } else {
          item.id = Number(item.id);
        }

        var i = indexOf2(oldVal, item.id);

        if (i > -1) {
          if (diff(item, oldVal[i])) {
            adds.push(item);
      ...
      this._oldMarkers = newVal;

      for (var i = 0; i < oldVal.length; i++) {
        if (exists.indexOf(i) === -1) {
          removes.push(Number(oldVal[i].id));
        }
      }

      this._markers = this._markers.filter(function (item) {
        return removes.indexOf(item.id) < 0;
      });
      ...
      var markers = this._transformPath(this._transformMarkers(adds), window.__route__);

      var addMarker = function (markers) {
        _this7._markers.push(...markers);
      ...
      markers.forEach(function (marker, index) {
        ...
        if (iconPath && /^cloud:\/\//.test(iconPath)) {
          cloudMap[iconPath] = index;
        }
      });
      var cloudIds = Object.keys(cloudMap);
      this.getCloudFileUrls(cloudIds, 'image', function (tempUrls) {
        tempUrls.forEach(function (tempUrl, idx) {
          var marker = markers[cloudMap[cloudIds[idx]]];
          marker.iconPath = tempUrl;
        });
        addMarker(markers);
      });
    },
    _transformPath: function (arr, route) {
      var _this8 = this;
      ...
      var markers = arr.map(function (item) {
        ...
        var path = ret.iconPath;
        ret.iconPath = /^(cloud|wxfile|https?):\/\//.test(path) ? path : _this8.getRealRoute(path, route);
        return ret;
      });
      return markers;
    },
    inesChanged: function (newVal = [], oldVal = []) {
      var _this9 = this;

      if (!this._isReady) {
        this._delay('linesChanged', newVal, oldVal);

        return;
      }

      oldVal = this._oldPolyLines || [];
      newVal = newVal.filter(function (item) {
        return !!item && typeof item === 'object';
      });
      var adds = [];
      var removes = [];
      var exists = [];
      newVal = newVal.map(function (line) {
      ...
      this._oldPolyLines = newVal;

      for (var i = 0; i < oldVal.length; i++) {
        if (exists.indexOf(i) === -1) {
          removes.push(oldVal[i].id);
        }
      }

      wx.invoke('removeMapLines', {
        mapId: this._mapId,
        lines: removes
      }, function () {});

      var lines = this._transformLines(adds);

      this.invoke('addMapLines', {
        mapId: this._mapId,
        lines: lines,
        clear: false
      }, function () {
        _this9.triggerEvent('updated');
      });
    },
    _transformLines: function (lines) {
      var _this10 = this;
      ...
      lines.forEach(function (item) {
        ...
        if (ret.arrowIconPath) {
          var path = ret.arrowIconPath;
          ret.arrowIconPath = path.indexOf('wxfile://') > -1 || path.match(/^https?:\/\//) ? path : _this10.getRealRoute(path, window.__route__);
        }

        ret.width = _this10.normalizeSize(ret.width || 1);
        ret.level = ret.level || 'abovelabels';
        result.push(ret);
      });
      return result;
    },
    circlesChanged: function (newVal = [], oldVal) {
      var _this11 = this;

      if (!this._isReady) {
        this._delay('circlesChanged', newVal, oldVal);
      ...
      this.invoke('addMapCircles', {
        mapId: this._mapId,
        circles: newVal
      }, function () {
        _this11.triggerEvent('updated');
      });
    },
    pointsChanged: function (newVal = [], oldVal) {
      if (!this._isReady) {
        this._delay('pointsChanged', newVal, oldVal);
    ...
    controlsChanged: function (newVal = [], oldVal) {
      if (!this._isReady) {
        this._delay('controlsChanged', newVal, oldVal);

        return;
      }

      var controls = this._transformPath(this._transformControls(newVal), window.__route__);

      this.invoke('addMapControls', {
        mapId: this._mapId,
        controls: controls
      }, function () {});
    },
    polygonsChanged: function (newVal = [], oldVal) {
      var _this12 = this;

      console.log('polygonsChanged ', this._isReady);

      if (!this._isReady) {
        this._delay('polygonsChanged', newVal, oldVal);
      ...
      newVal.forEach(function (item) {
        ...
        item.fillColor = item.fillColor || '#00000000';
        item.strokeColor = item.strokeColor || '#000000FF';
      ...
      this.invoke('addMapPolygons', {
        mapId: this._mapId,
        polygons: newVal
      }, function () {
        _this12.triggerEvent('updated');
      });
    },
    showLocationChanged: function (newVal = false, oldVal) {
      if (!this._isReady) {
        this._delay('showLocationChanged', newVal, oldVal);
    ...
    showScaleChanged: function (newVal = false, oldVal) {
      if (!this._isReady) {
        this._delay('showScaleChanged', newVal, oldVal);
    ...
    rotateChanged: function (newVal = 0, oldVal) {
      if (!this._isReady) {
        this._delay('rotateChanged', newVal, oldVal);
    ...
    skewChanged: function (newVal = 0, oldVal) {
      if (!this._isReady) {
        this._delay('skewChanged', newVal, oldVal);
    ...
    enableIndoorChanged: function (newVal = false, oldVal) {
      var _this13 = this;

      if (!this._isReady) {
        this._delay('enableIndoorChanged', newVal, oldVal);
      ...
      if (this.insert2XWebEnabled()) {
        window.requestAnimationFrame(function () {
          _this13._enableIndoorLevelPickChanged(newVal, _this13.enableIndoorLevelPick);
        });
      }
    ...
    layerStyleChanged: function (newVal, oldVal) {
      if (!this._isReady) {
        this._delay('layerStyleChanged', newVal, oldVal);
    ...
    enableZoomChanged: function (newVal = false, oldVal) {
      if (!this._isReady) {
        this._delay('enableZoomChanged', newVal, oldVal);
    ...
    enableScrollChanged: function (newVal = false, oldVal) {
      if (!this._isReady) {
        this._delay('enableScrollChanged', newVal, oldVal);
    ...
    enableRotateChanged: function (newVal = false, oldVal) {
      if (!this._isReady) {
        this._delay('enableRotateChanged', newVal, oldVal);
    ...
    showCompassChanged: function (newVal = false, oldVal) {
      if (!this._isReady) {
        this._delay('showCompassChanged', newVal, oldVal);
    ...
    enable3DChanged: function (newVal = false, oldVal) {
      if (!this._isReady) {
        this._delay('enable3DChanged', newVal, oldVal);
    ...
    enableOverlookingChanged: function (newVal = false, oldVal) {
      if (!this._isReady) {
        this._delay('enableOverlookingChanged', newVal, oldVal);

        return;
      }

      this._update({
        enableOverlooking: newVal
      });
    },
    enableSatelliteChanged: function (newVal = false, oldVal) {
      if (!this._isReady) {
        this._delay('enableSatelliteChanged', newVal, oldVal);

        return;
      }

      this._update({
        enableSatellite: newVal
      });
    },
    enableTrafficChanged: function (newVal = false, oldVal) {
      if (!this._isReady) {
        this._delay('enableTrafficChanged', newVal, oldVal);

        return;
      }

      this._update({
        enableTraffic: newVal
      });
    },
    enablePoiChanged: function (newVal = false, oldVal) {
      if (!this._isReady) {
        this._delay('enablePoiChanged', newVal, oldVal);
    ...
    enableBuildingChanged: function (newVal = false, oldVal) {
      if (!this._isReady) {
        this._delay('enableBuildingChanged', newVal, oldVal);

        return;
      }

      this._update({
        enableBuilding: newVal
      });
    },
    settingChanged: function (newVal = {}, oldVal) {
      if (!this._isReady) {
        this._delay('settingChanged', newVal, oldVal);
...
var scrollView = {
  ...
  properties: {
    ...
    scrollTop: {
      ...
      public: true,
      filter: function (val) {
        var scrollTop = (0,_utils_size__WEBPACK_IMPORTED_MODULE_1__.normalizeSize)(val);
        this.node.setAttributes({
          scrollTop: scrollTop
        });
      }
    ...
    scrollLeft: {
      ...
      public: true,
      filter: function (val) {
        var scrollLeft = (0,_utils_size__WEBPACK_IMPORTED_MODULE_1__.normalizeSize)(val);
        this.node.setAttributes({
  ...
  lifetimes: {
    ...
    attached: function () {
      ...
      this.attachNativeEvents().then(function () {
        _this.bindScrollEvent();

        _this.node.setAttributes({
          hasUIOnScroll: _this.hasUIOnScroll
        });
      });
    }
  },
  methods: {
    ...
    attachNativeEvents: function () {
      var _ref = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()(function* () {
        ...
        for (var item of nativeEvents) {
          var worklet = yield this.obtainWorkletFunc(item.methodName);
          if (typeof worklet !== 'function') return;

          if (item.eventName === 'onScroll') {
            this.hasUIOnScroll = true;
          }

          this.addWorkeltEventHandler(item.eventName, worklet, this.node.viewTag);
        }
      });
  ...
  methods: {
    ...
    bindScrollEvent: function () {
      ...
      if (!this.hasUIOnScroll && this.bindtransition) {
        this.$$.onScrollEvent(function (deltaPixels) {
          ...
          _this3.triggerEvent('transition', {
            dx: dx,
            dy: dy
          });
        });
    ...
    attachNativeEvents: function () {
      var _ref = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()(function* () {
        ...
        nativeEvents.forEach( /*#__PURE__*/function () {
          var _ref2 = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()(function* (item) {
            var worklet = yield _this4.obtainWorkletFunc(item.methodName);
            if (typeof worklet !== 'function') return;

            if (item.eventName === 'onTransition') {
              _this4.hasUIOnScroll = true;
            }

            _this4.addWorkeltEventHandler(item.eventName, worklet, _this4.$$.viewTag);
          });
...
function _ref() {
    ...
    exparser.registerElement({
            ...
            C: [{
              ...
              C: [{
                ...
                A: {
                  ...
                  "style": {
                    L: function (D, S, T) {
                      return !!D.option || undefined;
                    },
                    F: function (D, S, T, W) {
                      return "background-color: " + (D.option == 1 ? "yellow" : "white") + ";";
                    }
                  }
                },
                C: [{
                ...
                A: {
                  ...
                  "style": {
                    ...
                    F: function (D, S, T, W) {
                      return "background-color: " + (D.option == 2 ? "yellow" : "white") + ";";
                    }
                  }
                },
                C: [{
              ...
              C: [{
                ...
                C: [{
                  ...
                  A: {
                    "class": {
                      L: function (D, S, T) {
                        return !!(D.option || D.option || D.option) || undefined;
                      },
                      F: function (D, S, T, W) {
                        return "rect " + (D.option == 1 ? "change" : "") + " " + (D.option == 2 ? "change2" : "") + " " + (D.option == 3 ? "change3" : "");
                      }
                    }
                  },
                  C: []
      ...
      methods: {
        changeOption: function (e) {
          ...
          if (this.data.option == option) option = 0;
          this.setData({
            option: option
          });
        },
  ...
  `;
    var context = yield runtime.pageReady(0);
    exparser.globalOptions.customContext = context;
    exparser.initBackend();
    context.appendStyleSheet(styles, 1);
    var element = exparser.createElement('animation-ball');
    runtime.attachRootElement(element, pageId);
  });
  return _ref.apply(this, arguments);
}
...
var Bezier = function () {
  var _f = function (mX1, mY1, mX2, mY2) {
    ...
    var A = function () {
      ...
      _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Bezier.ts (20:2)";
      _f.__worklet = true;
      return _f;
    }();
    ...
    var B = function () {
      ...
      _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Bezier.ts (24:2)";
      _f.__worklet = true;
      return _f;
    }();
    ...
    var C = function () {
      ...
      _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Bezier.ts (28:2)";
      _f.__worklet = true;
      return _f;
    }();
    ...
    var calcBezier = function () {
      ...
      _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Bezier.ts (34:2)";
      _f.__worklet = true;
      return _f;
    }();
    ...
    var getSlope = function () {
      ...
      _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Bezier.ts (40:2)";
      _f.__worklet = true;
      return _f;
    }();
    ...
    var binarySubdivide = function () {
      ...
      _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Bezier.ts (45:2)";
      _f.__worklet = true;
      return _f;
    }();
    ...
    var newtonRaphsonIterate = function () {
      ...
      _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Bezier.ts (62:2)";
      _f.__worklet = true;
      return _f;
    }();
    ...
    var LinearEasing = function () {
      ...
      _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Bezier.ts (75:2)";
      _f.__worklet = true;
      return _f;
    }();
    ...
    var getTForX = function () {
      ...
      _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Bezier.ts (102:2)";
      _f.__worklet = true;
      return _f;
    }();
    ...
    return function () {
      ...
      _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Bezier.ts (127:9)";
      _f.__worklet = true;
      return _f;
    }();
  };
  ...
  _f._closure = {};
  _f.asString = "function Bezier(mX1,mY1,mX2,mY2){var NEWTON_ITERATIONS=4;var NEWTON_MIN_SLOPE=0.001;var SUBDIVISION_PRECISION=0.0000001;var SUBDIVISION_MAX_ITERATIONS=10;var kSplineTableSize=11;var kSampleStepSize=1.0/(kSplineTableSize-1.0);var A=function(){var _f=function(aA1,aA2){return 1.0-3.0*aA2+3.0*aA1;};_f._closure={};_f.asString=\"function A(aA1,aA2){return 1.0-3.0*aA2+3.0*aA1;}\";_f.__workletHash=7696928702327;_f.__location=\"/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Bezier.ts (20:2)\";_f.__worklet=true;return _f;}();var B=function(){var _f=function(aA1,aA2){return 3.0*aA2-6.0*aA1;};_f._closure={};_f.asString=\"function B(aA1,aA2){return 3.0*aA2-6.0*aA1;}\";_f.__workletHash=3169786778773;_f.__location=\"/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Bezier.ts (24:2)\";_f.__worklet=true;return _f;}();var C=function(){var _f=function(aA1){return 3.0*aA1;};_f._closure={};_f.asString=\"function C(aA1){return 3.0*aA1;}\";_f.__workletHash=6399610653367;_f.__location=\"/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Bezier.ts (28:2)\";_f.__worklet=true;return _f;}();var calcBezier=function(){var _f=function(aT,aA1,aA2){return((A(aA1,aA2)*aT+B(aA1,aA2))*aT+C(aA1))*aT;};_f._closure={A:A,B:B,C:C};_f.asString=\"function calcBezier(aT,aA1,aA2){const{A,B,C}=jsThis._closure;{return((A(aA1,aA2)*aT+B(aA1,aA2))*aT+C(aA1))*aT;}}\";_f.__workletHash=3153137150968;_f.__location=\"/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Bezier.ts (34:2)\";_f.__worklet=true;return _f;}();var getSlope=function(){var _f=function(aT,aA1,aA2){return 3.0*A(aA1,aA2)*aT*aT+2.0*B(aA1,aA2)*aT+C(aA1);};_f._closure={A:A,B:B,C:C};_f.asString=\"function getSlope(aT,aA1,aA2){const{A,B,C}=jsThis._closure;{return 3.0*A(aA1,aA2)*aT*aT+2.0*B(aA1,aA2)*aT+C(aA1);}}\";_f.__workletHash=17050227570308;_f.__location=\"/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Bezier.ts (40:2)\";_f.__worklet=true;return _f;}();var binarySubdivide=function(){var _f=function(aX,aA,aB,mX1,mX2){var currentX;var currentT;var i=0;do{currentT=aA+(aB-aA)/2.0;currentX=calcBezier(currentT,mX1,mX2)-aX;if(currentX>0.0){aB=currentT;}else{aA=currentT;}}while(Math.abs(currentX)>SUBDIVISION_PRECISION&&++i<SUBDIVISION_MAX_ITERATIONS);return currentT;};_f._closure={SUBDIVISION_PRECISION:SUBDIVISION_PRECISION,SUBDIVISION_MAX_ITERATIONS:SUBDIVISION_MAX_ITERATIONS,calcBezier:calcBezier};_f.asString=\"function binarySubdivide(aX,aA,aB,mX1,mX2){const{SUBDIVISION_PRECISION,SUBDIVISION_MAX_ITERATIONS,calcBezier}=jsThis._closure;{var currentX;var currentT;var i=0;do{currentT=aA+(aB-aA)/2.0;currentX=calcBezier(currentT,mX1,mX2)-aX;if(currentX>0.0){aB=currentT;}else{aA=currentT;}}while(Math.abs(currentX)>SUBDIVISION_PRECISION&&++i<SUBDIVISION_MAX_ITERATIONS);return currentT;}}\";_f.__workletHash=8216390185547;_f.__location=\"/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Bezier.ts (45:2)\";_f.__worklet=true;return _f;}();var newtonRaphsonIterate=function(){var _f=function(aX,aGuessT,mX1,mX2){for(var i=0;i<NEWTON_ITERATIONS;++i){var currentSlope=getSlope(aGuessT,mX1,mX2);if(currentSlope===0.0){return aGuessT;}var currentX=calcBezier(aGuessT,mX1,mX2)-aX;aGuessT-=currentX/currentSlope;}return aGuessT;};_f._closure={NEWTON_ITERATIONS:NEWTON_ITERATIONS,getSlope:getSlope,calcBezier:calcBezier};_f.asString=\"function newtonRaphsonIterate(aX,aGuessT,mX1,mX2){const{NEWTON_ITERATIONS,getSlope,calcBezier}=jsThis._closure;{for(var i=0;i<NEWTON_ITERATIONS;++i){var currentSlope=getSlope(aGuessT,mX1,mX2);if(currentSlope===0.0){return aGuessT;}var currentX=calcBezier(aGuessT,mX1,mX2)-aX;aGuessT-=currentX/currentSlope;}return aGuessT;}}\";_f.__workletHash=5901993849860;_f.__location=\"/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Bezier.ts (62:2)\";_f.__worklet=true;return _f;}();var LinearEasing=function(){var _f=function(x){return x;};_f._closure={};_f.asString=\"function LinearEasing(x){return x;}\";_f.__workletHash=3962143445177;_f.__location=\"/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Bezier.ts (75:2)\";_f.__worklet=true;return _f;}();if(!(mX1>=0&&mX1<=1&&mX2>=0&&mX2<=1)){throw new Error('bezier x values must be in [0, 1] range');}if(mX1===mY1&&mX2===mY2){return LinearEasing;}var sampleValues=new Array(kSplineTableSize);for(var i=0;i<kSplineTableSize;++i){sampleValues[i]=calcBezier(i*kSampleStepSize,mX1,mX2);}var getTForX=function(){var _f=function(aX){var intervalStart=0.0;var currentSample=1;var lastSample=kSplineTableSize-1;for(;currentSample!==lastSample&&sampleValues[currentSample]<=aX;++currentSample){intervalStart+=kSampleStepSize;}--currentSample;var dist=(aX-sampleValues[currentSample])/(sampleValues[currentSample+1]-sampleValues[currentSample]);var guessForT=intervalStart+dist*kSampleStepSize;var initialSlope=getSlope(guessForT,mX1,mX2);if(initialSlope>=NEWTON_MIN_SLOPE){return newtonRaphsonIterate(aX,guessForT,mX1,mX2);}else if(initialSlope===0.0){return guessForT;}else{return binarySubdivide(aX,intervalStart,intervalStart+kSampleStepSize,mX1,mX2);}};_f._closure={kSplineTableSize:kSplineTableSize,sampleValues:sampleValues,kSampleStepSize:kSampleStepSize,getSlope:getSlope,mX1:mX1,mX2:mX2,NEWTON_MIN_SLOPE:NEWTON_MIN_SLOPE,newtonRaphsonIterate:newtonRaphsonIterate,binarySubdivide:binarySubdivide};_f.asString=\"function getTForX(aX){const{kSplineTableSize,sampleValues,kSampleStepSize,getSlope,mX1,mX2,NEWTON_MIN_SLOPE,newtonRaphsonIterate,binarySubdivide}=jsThis._closure;{var intervalStart=0.0;var currentSample=1;var lastSample=kSplineTableSize-1;for(;currentSample!==lastSample&&sampleValues[currentSample]<=aX;++currentSample){intervalStart+=kSampleStepSize;}--currentSample;var dist=(aX-sampleValues[currentSample])/(sampleValues[currentSample+1]-sampleValues[currentSample]);var guessForT=intervalStart+dist*kSampleStepSize;var initialSlope=getSlope(guessForT,mX1,mX2);if(initialSlope>=NEWTON_MIN_SLOPE){return newtonRaphsonIterate(aX,guessForT,mX1,mX2);}else if(initialSlope===0.0){return guessForT;}else{return binarySubdivide(aX,intervalStart,intervalStart+kSampleStepSize,mX1,mX2);}}}\";_f.__workletHash=10148290284160;_f.__location=\"/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Bezier.ts (102:2)\";_f.__worklet=true;return _f;}();return function(){var _f=function(x){if(mX1===mY1&&mX2===mY2){return x;}if(x===0){return 0;}if(x===1){return 1;}return calcBezier(getTForX(x),mY1,mY2);};_f._closure={mX1:mX1,mY1:mY1,mX2:mX2,mY2:mY2,calcBezier:calcBezier,getTForX:getTForX};_f.asString=\"function BezierEasing(x){const{mX1,mY1,mX2,mY2,calcBezier,getTForX}=jsThis._closure;{if(mX1===mY1&&mX2===mY2){return x;}if(x===0){return 0;}if(x===1){return 1;}return calcBezier(getTForX(x),mY1,mY2);}}\";_f.__workletHash=8676971518933;_f.__location=\"/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Bezier.ts (127:9)\";_f.__worklet=true;return _f;}();}";
  _f.__workletHash = 13946007493372;
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Bezier.ts (9:7)";
  _f.__worklet = true;
  return _f;
}();
...
/* harmony export */ });
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util */ "./src/reanimated/util.ts");
...
var call = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Colors.ts (33:0)";
  _f.__worklet = true;
  return _f;
}();
...
var getUICachedMatchers = function () {
  var _f = function () {
    var cacheName = (0,_util__WEBPACK_IMPORTED_MODULE_0__.genWrapperProperty)('uiCachedMatchers');

    if (typeof globalThis[cacheName] == 'undefined') {
      globalThis[cacheName] = {};
    }
  ...
  _f._closure = {
    genWrapperProperty: _util__WEBPACK_IMPORTED_MODULE_0__.genWrapperProperty
  };
  _f.asString = "function _f(){const{genWrapperProperty}=jsThis._closure;{var cacheName=genWrapperProperty('uiCachedMatchers');if(typeof globalThis[cacheName]=='undefined'){globalThis[cacheName]={};}return globalThis[cacheName];}}";
  _f.__workletHash = 9394915299455;
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Colors.ts (42:28)";
  _f.__worklet = true;
  return _f;
}();
...
var getMatchers = function () {
  var _f = function () {
    var cachedMatchers = _WORKLET ? getUICachedMatchers() : jsCachedMatchers;
  ...
  _f._closure = {
    getUICachedMatchers: getUICachedMatchers,
    jsCachedMatchers: jsCachedMatchers,
    call: call,
    NUMBER: NUMBER,
    PERCENTAGE: PERCENTAGE
  };
  _f.asString = "function getMatchers(){const{getUICachedMatchers,jsCachedMatchers,call,NUMBER,PERCENTAGE}=jsThis._closure;{var cachedMatchers=_WORKLET?getUICachedMatchers():jsCachedMatchers;if(cachedMatchers.rgb===undefined){cachedMatchers.rgb=new RegExp('rgb'+call(NUMBER,NUMBER,NUMBER));cachedMatchers.rgba=new RegExp('rgba'+call(NUMBER,NUMBER,NUMBER,NUMBER));cachedMatchers.hsl=new RegExp('hsl'+call(NUMBER,PERCENTAGE,PERCENTAGE));cachedMatchers.hsla=new RegExp('hsla'+call(NUMBER,PERCENTAGE,PERCENTAGE,NUMBER));cachedMatchers.hex3=/^#([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/;cachedMatchers.hex4=/^#([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/;cachedMatchers.hex6=/^#([0-9a-fA-F]{6})$/;cachedMatchers.hex8=/^#([0-9a-fA-F]{8})$/;}return cachedMatchers;}}";
  _f.__workletHash = 16923193260585;
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Colors.ts (65:0)";
  _f.__worklet = true;
  return _f;
}();
...
var hue2rgb = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Colors.ts (85:0)";
  _f.__worklet = true;
  return _f;
}();
...
var hslToRgb = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Colors.ts (105:0)";
  _f.__worklet = true;
  return _f;
}();
...
var parse255 = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Colors.ts (116:0)";
  _f.__worklet = true;
  return _f;
}();
...
var parse360 = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Colors.ts (128:0)";
  _f.__worklet = true;
  return _f;
}();
...
var parse1 = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Colors.ts (134:0)";
  _f.__worklet = true;
  return _f;
}();
...
var parsePercentage = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Colors.ts (146:0)";
  _f.__worklet = true;
  return _f;
}();
...
var normalizeColor = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Colors.ts (315:0)";
  _f.__worklet = true;
  return _f;
}();
...
var opacity = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Colors.ts (427:23)";
  _f.__worklet = true;
  return _f;
}();
var red = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Colors.ts (432:19)";
  _f.__worklet = true;
  return _f;
}();
var green = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Colors.ts (437:21)";
  _f.__worklet = true;
  return _f;
}();
var blue = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Colors.ts (442:20)";
  _f.__worklet = true;
  return _f;
}();
var rgbaColor = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Colors.ts (447:25)";
  _f.__worklet = true;
  return _f;
}();
...
var RGBtoHSV = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Colors.ts (467:0)";
  _f.__worklet = true;
  return _f;
}();
...
var HSVtoRGB = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Colors.ts (520:0)";
  _f.__worklet = true;
  return _f;
}();
...
var hsvToColor = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Colors.ts (562:26)";
  _f.__worklet = true;
  return _f;
}();
var processColorInitially = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Colors.ts (568:7)";
  _f.__worklet = true;
  return _f;
}();
var isColor = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Colors.ts (588:7)";
  _f.__worklet = true;
  return _f;
}();
var processColor = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Colors.ts (596:7)";
  _f.__worklet = true;
  return _f;
}();
var convertToHSVA = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Colors.ts (618:7)";
  _f.__worklet = true;
  return _f;
}();
var toRGBA = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Colors.ts (629:7)";
  _f.__worklet = true;
  return _f;
}();
...
var linear = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Easing.ts (62:0)";
  _f.__worklet = true;
  return _f;
}();
...
var ease = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Easing.ts (73:0)";
  _f.__worklet = true;
  return _f;
}();
...
var quad = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Easing.ts (84:0)";
  _f.__worklet = true;
  return _f;
}();
...
var cubic = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Easing.ts (95:0)";
  _f.__worklet = true;
  return _f;
}();
...
var poly = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Easing.ts (106:0)";
  _f.__worklet = true;
  return _f;
}();
...
var sin = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Easing.ts (116:0)";
  _f.__worklet = true;
  return _f;
}();
...
var circle = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Easing.ts (126:0)";
  _f.__worklet = true;
  return _f;
}();
...
var exp = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Easing.ts (136:0)";
  _f.__worklet = true;
  return _f;
}();
...
var elastic = function () {
  var _f = function (bounciness = 1) {
    ...
    return function () {
      ...
      _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Easing.ts (154:9)";
      _f.__worklet = true;
      return _f;
    }();
  };
  ...
  _f._closure = {};
  _f.asString = "function elastic(bounciness=1){var p=bounciness*Math.PI;return function(){var _f=function(t){return 1-Math.pow(Math.cos(t*Math.PI/2),3)*Math.cos(t*p);};_f._closure={p:p};_f.asString=\"function _f(t){const{p}=jsThis._closure;{return 1-Math.pow(Math.cos(t*Math.PI/2),3)*Math.cos(t*p);}}\";_f.__workletHash=8897284077766;_f.__location=\"/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Easing.ts (154:9)\";_f.__worklet=true;return _f;}();}";
  _f.__workletHash = 12074354969319;
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Easing.ts (151:0)";
  _f.__worklet = true;
  return _f;
}();
...
var back = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Easing.ts (168:0)";
  _f.__worklet = true;
  return _f;
}();
...
var bounce = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Easing.ts (178:0)";
  _f.__worklet = true;
  return _f;
}();
...
var bezier = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Easing.ts (205:0)";
  _f.__worklet = true;
  return _f;
}();
...
var in_ = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Easing.ts (213:0)";
  _f.__worklet = true;
  return _f;
}();
...
var out = function () {
  var _f = function (easing) {
    return function () {
      ...
      _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Easing.ts (223:9)";
      _f.__worklet = true;
      return _f;
    }();
  };
  ...
  _f._closure = {};
  _f.asString = "function out(easing){return function(){var _f=function(t){return 1-easing(1-t);};_f._closure={easing:easing};_f.asString=\"function _f(t){const{easing}=jsThis._closure;{return 1-easing(1-t);}}\";_f.__workletHash=5726884014519;_f.__location=\"/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Easing.ts (223:9)\";_f.__worklet=true;return _f;}();}";
  _f.__workletHash = 8000913372352;
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Easing.ts (221:0)";
  _f.__worklet = true;
  return _f;
}();
...
var inOut = function () {
  var _f = function (easing) {
    return function () {
      ...
      _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Easing.ts (236:9)";
      _f.__worklet = true;
      return _f;
    }();
  };
  ...
  _f._closure = {};
  _f.asString = "function inOut(easing){return function(){var _f=function(t){if(t<0.5){return easing(t*2)/2;}return 1-easing((1-t)*2)/2;};_f._closure={easing:easing};_f.asString=\"function _f(t){const{easing}=jsThis._closure;{if(t<0.5){return easing(t*2)/2;}return 1-easing((1-t)*2)/2;}}\";_f.__workletHash=2325007799982;_f.__location=\"/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Easing.ts (236:9)\";_f.__worklet=true;return _f;}();}";
  _f.__workletHash = 13648402905708;
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Easing.ts (234:0)";
  _f.__worklet = true;
  return _f;
}();
...
/* harmony export */   "createAnimatedStyle": () => (/* binding */ createAnimatedStyle)
/* harmony export */ });
...
function derived(processor) {
  ...
  var fun = function () {
    ...
    _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Hooks.ts (15:14)";
    _f.__worklet = true;
    return _f;
  }();
...
var prepareAnimation = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Hooks.ts (23:0)";
  _f.__worklet = true;
  return _f;
}();
...
var runAnimations = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Hooks.ts (71:0)";
  _f.__worklet = true;
  return _f;
}();
...
var isAnimated = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Hooks.ts (120:0)";
  _f.__worklet = true;
  return _f;
}();
...
var styleDiff = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Hooks.ts (137:0)";
  _f.__worklet = true;
  return _f;
}();
...
var styleUpdater = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Hooks.ts (161:0)";
  _f.__worklet = true;
  return _f;
}();

function createAnimatedStyle(updater, adapters) {
  ...
  var fun = function () {
    var _f = function (shadowNode) {
      if (typeof shadowNode === 'undefined') return;
    ...
    _f.asString = "function _f(shadowNode){const{styleUpdater,updater,remoteState,adapters,animationsActive}=jsThis._closure;{if(typeof shadowNode==='undefined')return;styleUpdater(shadowNode,updater,remoteState,adapters,animationsActive);}}";
    _f.__workletHash = 1576235342194;
    _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/Hooks.ts (250:14)";
    _f.__worklet = true;
    return _f;
  }();
...
var ColorProperties = colorProps;
var updateProps = function () {
  var _f = function (shadowNode, updates, adapters) {
    ...
    console.error('@@@ ', JSON.stringify(updates));
  ...
  _f.asString = "function _f(shadowNode,updates,adapters){const{ColorProperties,processColor}=jsThis._closure;{if(adapters){adapters.forEach(function(adapter){adapter(updates);});}Object.keys(updates).forEach(function(key){if(ColorProperties.indexOf(key)!==-1){updates[key]=processColor(updates[key]);}});console.error('@@@ ',JSON.stringify(updates));_updateStyle(shadowNode,updates);}}";
  _f.__workletHash = 12457761224327;
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/UpdateProps.ts (27:27)";
  _f.__worklet = true;
  return _f;
}();
...
var transform = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/animations.ts (16:7)";
  _f.__worklet = true;
  return _f;
}();
var transformAnimation = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/animations.ts (42:7)";
  _f.__worklet = true;
  return _f;
}();
var decorateAnimation = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/animations.ts (52:7)";
  _f.__worklet = true;
  return _f;
}();
var defineAnimation = function () {
  var _f = function (starting, factory) {
    ...
    var create = function () {
      ...
      _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/animations.ts (143:17)";
      _f.__worklet = true;
      return _f;
    }();
...
var cancelAnimation = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/animations.ts (156:7)";
  _f.__worklet = true;
  return _f;
}();
var timing = function () {
  var _f = function (toValue, userConfig, callback) {
    return defineAnimation(toValue, function () {
      ...
      _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/animations.ts (165:34)";
      _f.__worklet = true;
      return _f;
    }());
  };
  ...
  _f.asString = "function timing(toValue,userConfig,callback){const{defineAnimation,Easing}=jsThis._closure;{return defineAnimation(toValue,function(){var _f=function(){var config={duration:300,easing:Easing.inOut(Easing.quad)};if(userConfig){Object.keys(userConfig).forEach(function(key){return config[key]=userConfig[key];});}function timing(animation,now){var{toValue:toValue,progress:progress,startTime:startTime,current:current}=animation;var runtime=now-startTime;if(runtime>=config.duration){animation.startTime=0;animation.current=toValue;return true;}var newProgress=config.easing(runtime/config.duration);var dist=(toValue-current)*(newProgress-progress)/(1-progress);animation.current+=dist;animation.progress=newProgress;return false;}function onStart(animation,value,now,previousAnimation){if(previousAnimation&&previousAnimation.type==='timing'&&previousAnimation.toValue===toValue&&previousAnimation.startTime){animation.startTime=previousAnimation.startTime;animation.progress=previousAnimation.progress;}else{animation.startTime=now;animation.progress=0;}animation.current=value;}return{type:'timing',onFrame:timing,onStart:onStart,progress:0,toValue:toValue,current:toValue,callback:callback};};_f._closure={Easing:{inOut:Easing.inOut,quad:Easing.quad},userConfig:userConfig,toValue:toValue,callback:callback};_f.asString=\"function _f(){const{Easing,userConfig,toValue,callback}=jsThis._closure;{var config={duration:300,easing:Easing.inOut(Easing.quad)};if(userConfig){Object.keys(userConfig).forEach(function(key){return config[key]=userConfig[key];});}function timing(animation,now){var{toValue:toValue,progress:progress,startTime:startTime,current:current}=animation;var runtime=now-startTime;if(runtime>=config.duration){animation.startTime=0;animation.current=toValue;return true;}var newProgress=config.easing(runtime/config.duration);var dist=(toValue-current)*(newProgress-progress)/(1-progress);animation.current+=dist;animation.progress=newProgress;return false;}function onStart(animation,value,now,previousAnimation){if(previousAnimation&&previousAnimation.type==='timing'&&previousAnimation.toValue===toValue&&previousAnimation.startTime){animation.startTime=previousAnimation.startTime;animation.progress=previousAnimation.progress;}else{animation.startTime=now;animation.progress=0;}animation.current=value;}return{type:'timing',onFrame:timing,onStart:onStart,progress:0,toValue:toValue,current:toValue,callback:callback};}}\";_f.__workletHash=6093059965943;_f.__location=\"/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/animations.ts (165:34)\";_f.__worklet=true;return _f;}());}}";
  _f.__workletHash = 11989223135159;
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/animations.ts (162:7)";
  _f.__worklet = true;
  return _f;
}();
var spring = function () {
  var _f = function (toValue, userConfig, callback) {
    return defineAnimation(toValue, function () {
      ...
      _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/animations.ts (229:34)";
      _f.__worklet = true;
      return _f;
    }());
  };
  ...
  _f.asString = "function spring(toValue,userConfig,callback){const{defineAnimation}=jsThis._closure;{return defineAnimation(toValue,function(){var _f=function(){var config={damping:10,mass:1,stiffness:100,overshootClamping:false,restDisplacementThreshold:0.01,restSpeedThreshold:2};if(userConfig){Object.keys(userConfig).forEach(function(key){return config[key]=userConfig[key];});}function spring(animation,now){var{toValue:toValue,lastTimestamp:lastTimestamp,current:current,velocity:velocity}=animation;var deltaTime=Math.min(now-lastTimestamp,64);animation.lastTimestamp=now;var c=config.damping;var m=config.mass;var k=config.stiffness;var v0=-velocity;var x0=toValue-current;var zeta=c/(2*Math.sqrt(k*m));var omega0=Math.sqrt(k/m);var omega1=omega0*Math.sqrt(1-zeta**2);var t=deltaTime/1000;var sin1=Math.sin(omega1*t);var cos1=Math.cos(omega1*t);var underDampedEnvelope=Math.exp(-zeta*omega0*t);var underDampedFrag1=underDampedEnvelope*(sin1*((v0+zeta*omega0*x0)/omega1)+x0*cos1);var underDampedPosition=toValue-underDampedFrag1;var underDampedVelocity=zeta*omega0*underDampedFrag1-underDampedEnvelope*(cos1*(v0+zeta*omega0*x0)-omega1*x0*sin1);var criticallyDampedEnvelope=Math.exp(-omega0*t);var criticallyDampedPosition=toValue-criticallyDampedEnvelope*(x0+(v0+omega0*x0)*t);var criticallyDampedVelocity=criticallyDampedEnvelope*(v0*(t*omega0-1)+t*x0*omega0*omega0);var isOvershooting=function(){if(config.overshootClamping&&config.stiffness!==0){return current<toValue?animation.current>toValue:animation.current<toValue;}else{return false;}};var isVelocity=Math.abs(velocity)<config.restSpeedThreshold;var isDisplacement=config.stiffness===0||Math.abs(toValue-current)<config.restDisplacementThreshold;if(zeta<1){animation.current=underDampedPosition;animation.velocity=underDampedVelocity;}else{animation.current=criticallyDampedPosition;animation.velocity=criticallyDampedVelocity;}if(isOvershooting()||isVelocity&&isDisplacement){if(config.stiffness!==0){animation.velocity=0;animation.current=toValue;}return true;}}function onStart(animation,value,now,previousAnimation){animation.current=value;if(previousAnimation){animation.velocity=previousAnimation.velocity||animation.velocity||0;animation.lastTimestamp=previousAnimation.lastTimestamp||now;}else{animation.lastTimestamp=now;}}return{onFrame:spring,onStart:onStart,toValue:toValue,velocity:config.velocity||0,current:toValue,callback:callback};};_f._closure={userConfig:userConfig,toValue:toValue,callback:callback};_f.asString=\"function _f(){const{userConfig,toValue,callback}=jsThis._closure;{var config={damping:10,mass:1,stiffness:100,overshootClamping:false,restDisplacementThreshold:0.01,restSpeedThreshold:2};if(userConfig){Object.keys(userConfig).forEach(function(key){return config[key]=userConfig[key];});}function spring(animation,now){var{toValue:toValue,lastTimestamp:lastTimestamp,current:current,velocity:velocity}=animation;var deltaTime=Math.min(now-lastTimestamp,64);animation.lastTimestamp=now;var c=config.damping;var m=config.mass;var k=config.stiffness;var v0=-velocity;var x0=toValue-current;var zeta=c/(2*Math.sqrt(k*m));var omega0=Math.sqrt(k/m);var omega1=omega0*Math.sqrt(1-zeta**2);var t=deltaTime/1000;var sin1=Math.sin(omega1*t);var cos1=Math.cos(omega1*t);var underDampedEnvelope=Math.exp(-zeta*omega0*t);var underDampedFrag1=underDampedEnvelope*(sin1*((v0+zeta*omega0*x0)/omega1)+x0*cos1);var underDampedPosition=toValue-underDampedFrag1;var underDampedVelocity=zeta*omega0*underDampedFrag1-underDampedEnvelope*(cos1*(v0+zeta*omega0*x0)-omega1*x0*sin1);var criticallyDampedEnvelope=Math.exp(-omega0*t);var criticallyDampedPosition=toValue-criticallyDampedEnvelope*(x0+(v0+omega0*x0)*t);var criticallyDampedVelocity=criticallyDampedEnvelope*(v0*(t*omega0-1)+t*x0*omega0*omega0);var isOvershooting=function(){if(config.overshootClamping&&config.stiffness!==0){return current<toValue?animation.current>toValue:animation.current<toValue;}else{return false;}};var isVelocity=Math.abs(velocity)<config.restSpeedThreshold;var isDisplacement=config.stiffness===0||Math.abs(toValue-current)<config.restDisplacementThreshold;if(zeta<1){animation.current=underDampedPosition;animation.velocity=underDampedVelocity;}else{animation.current=criticallyDampedPosition;animation.velocity=criticallyDampedVelocity;}if(isOvershooting()||isVelocity&&isDisplacement){if(config.stiffness!==0){animation.velocity=0;animation.current=toValue;}return true;}}function onStart(animation,value,now,previousAnimation){animation.current=value;if(previousAnimation){animation.velocity=previousAnimation.velocity||animation.velocity||0;animation.lastTimestamp=previousAnimation.lastTimestamp||now;}else{animation.lastTimestamp=now;}}return{onFrame:spring,onStart:onStart,toValue:toValue,velocity:config.velocity||0,current:toValue,callback:callback};}}\";_f.__workletHash=13232297671722;_f.__location=\"/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/animations.ts (229:34)\";_f.__worklet=true;return _f;}());}}";
  _f.__workletHash = 13075446239880;
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/animations.ts (226:7)";
  _f.__worklet = true;
  return _f;
}();
var decay = function () {
  var _f = function (userConfig, callback) {
    return defineAnimation(0, function () {
      ...
      _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/animations.ts (336:28)";
      _f.__worklet = true;
      return _f;
    }());
  };
  ...
  _f.asString = "function decay(userConfig,callback){const{defineAnimation}=jsThis._closure;{return defineAnimation(0,function(){var _f=function(){var config={deceleration:0.998};if(userConfig){Object.keys(userConfig).forEach(function(key){return config[key]=userConfig[key];});}var VELOCITY_EPS=5;function decay(animation,now){var{lastTimestamp:lastTimestamp,initialVelocity:initialVelocity,current:current,velocity:velocity}=animation;var deltaTime=Math.min(now-lastTimestamp,64);animation.lastTimestamp=now;var kv=Math.pow(config.deceleration,deltaTime);var kx=config.deceleration*(1-kv)/(1-config.deceleration);var v0=velocity/1000;var v=v0*kv*1000;var x=current+v0*kx;animation.current=x;animation.velocity=v;var toValueIsReached=null;if(Array.isArray(config.clamp)){if(initialVelocity<0&&animation.current<=config.clamp[0]){toValueIsReached=config.clamp[0];}else if(initialVelocity>0&&animation.current>=config.clamp[1]){toValueIsReached=config.clamp[1];}}if(Math.abs(v)<VELOCITY_EPS||toValueIsReached!==null){if(toValueIsReached!==null){animation.current=toValueIsReached;}return true;}}function onStart(animation,value,now){animation.current=value;animation.lastTimestamp=now;animation.initialVelocity=config.velocity;}return{onFrame:decay,onStart:onStart,velocity:config.velocity||0,callback:callback};};_f._closure={userConfig:userConfig,callback:callback};_f.asString=\"function _f(){const{userConfig,callback}=jsThis._closure;{var config={deceleration:0.998};if(userConfig){Object.keys(userConfig).forEach(function(key){return config[key]=userConfig[key];});}var VELOCITY_EPS=5;function decay(animation,now){var{lastTimestamp:lastTimestamp,initialVelocity:initialVelocity,current:current,velocity:velocity}=animation;var deltaTime=Math.min(now-lastTimestamp,64);animation.lastTimestamp=now;var kv=Math.pow(config.deceleration,deltaTime);var kx=config.deceleration*(1-kv)/(1-config.deceleration);var v0=velocity/1000;var v=v0*kv*1000;var x=current+v0*kx;animation.current=x;animation.velocity=v;var toValueIsReached=null;if(Array.isArray(config.clamp)){if(initialVelocity<0&&animation.current<=config.clamp[0]){toValueIsReached=config.clamp[0];}else if(initialVelocity>0&&animation.current>=config.clamp[1]){toValueIsReached=config.clamp[1];}}if(Math.abs(v)<VELOCITY_EPS||toValueIsReached!==null){if(toValueIsReached!==null){animation.current=toValueIsReached;}return true;}}function onStart(animation,value,now){animation.current=value;animation.lastTimestamp=now;animation.initialVelocity=config.velocity;}return{onFrame:decay,onStart:onStart,velocity:config.velocity||0,callback:callback};}}\";_f.__workletHash=8868055353636;_f.__location=\"/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/animations.ts (336:28)\";_f.__worklet=true;return _f;}());}}";
  _f.__workletHash = 2637172790053;
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/animations.ts (333:7)";
  _f.__worklet = true;
  return _f;
}();
var delay = function () {
  var _f = function (delayMs, _nextAnimation) {
    return defineAnimation(_nextAnimation, function () {
      ...
      _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/animations.ts (399:41)";
      _f.__worklet = true;
      return _f;
    }());
  };
...
var sequence = function () {
  var _f = function (..._animations) {
    return defineAnimation(_animations[0], function () {
      var _f = function () {
        ...
        function onStart(animation, value, now, previousAnimation) {
          if (animations.length === 1) {
            throw Error('sequence() animation require more than one animation as argument');
          }
      ...
      _f.__workletHash = 11466091246532;
      _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/animations.ts (450:41)";
      _f.__worklet = true;
      return _f;
    }());
  };
...
var repeat = function () {
  var _f = function (_nextAnimation, numberOfReps = 2, reverse = false, callback) {
    return defineAnimation(_nextAnimation, function () {
      ...
      _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/animations.ts (519:41)";
      _f.__worklet = true;
      return _f;
    }());
  };
  ...
  _f.asString = "function repeat(_nextAnimation,numberOfReps=2,reverse=false,callback){const{defineAnimation}=jsThis._closure;{return defineAnimation(_nextAnimation,function(){var _f=function(){var nextAnimation=typeof _nextAnimation==='function'?_nextAnimation():_nextAnimation;function repeat(animation,now){var finished=nextAnimation.onFrame(nextAnimation,now);animation.current=nextAnimation.current;if(finished){animation.reps+=1;if(nextAnimation.callback){nextAnimation.callback(true,animation.current);}if(numberOfReps>0&&animation.reps>=numberOfReps){return true;}var startValue=reverse?nextAnimation.current:animation.startValue;if(reverse){nextAnimation.toValue=animation.startValue;animation.startValue=startValue;}nextAnimation.onStart(nextAnimation,startValue,now,nextAnimation.previousAnimation);return false;}return false;}var repCallback=function(finished){if(callback){callback(finished);}if(!finished&&nextAnimation.callback){nextAnimation.callback(false);}};function onStart(animation,value,now,previousAnimation){animation.startValue=value;animation.reps=0;nextAnimation.onStart(nextAnimation,value,now,previousAnimation);}return{isHigherOrder:true,onFrame:repeat,onStart:onStart,reps:0,current:nextAnimation.current,callback:repCallback};};_f._closure={_nextAnimation:_nextAnimation,numberOfReps:numberOfReps,reverse:reverse,callback:callback};_f.asString=\"function _f(){const{_nextAnimation,numberOfReps,reverse,callback}=jsThis._closure;{var nextAnimation=typeof _nextAnimation==='function'?_nextAnimation():_nextAnimation;function repeat(animation,now){var finished=nextAnimation.onFrame(nextAnimation,now);animation.current=nextAnimation.current;if(finished){animation.reps+=1;if(nextAnimation.callback){nextAnimation.callback(true,animation.current);}if(numberOfReps>0&&animation.reps>=numberOfReps){return true;}var startValue=reverse?nextAnimation.current:animation.startValue;if(reverse){nextAnimation.toValue=animation.startValue;animation.startValue=startValue;}nextAnimation.onStart(nextAnimation,startValue,now,nextAnimation.previousAnimation);return false;}return false;}var repCallback=function(finished){if(callback){callback(finished);}if(!finished&&nextAnimation.callback){nextAnimation.callback(false);}};function onStart(animation,value,now,previousAnimation){animation.startValue=value;animation.reps=0;nextAnimation.onStart(nextAnimation,value,now,previousAnimation);}return{isHigherOrder:true,onFrame:repeat,onStart:onStart,reps:0,current:nextAnimation.current,callback:repCallback};}}\";_f.__workletHash=10249133011380;_f.__location=\"/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/animations.ts (519:41)\";_f.__worklet=true;return _f;}());}}";
  _f.__workletHash = 6964461162785;
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/animations.ts (516:7)";
  _f.__worklet = true;
  return _f;
}();
...
/* harmony export */   "workletValueSetter": () => (/* binding */ workletValueSetter)
/* harmony export */ });
function makeShareable(value) {
  return SkylineGlobal.ReanimatedModule.makeShareable(value);
}
function makeMutable(val) {
  console.error('@@@ makeMutable ', typeof SkylineGlobal.ReanimatedModule);
  return SkylineGlobal.ReanimatedModule.makeMutable(val);
}
function makeRemote(val) {
  return SkylineGlobal.ReanimatedModule.makeRemote(val);
}
var requestFrame = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/core.ts (17:7)";
  _f.__worklet = true;
  return _f;
}();
...
var runOnJS = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/core.ts (24:23)";
  _f.__worklet = true;
  return _f;
}();
function startMapper(mapper, inputs = [], outputs = []) {
  return SkylineGlobal.ReanimatedModule.startMapper(mapper, inputs, outputs);
}
function stopMapper(mapperId) {
  SkylineGlobal.ReanimatedModule.stopMapper(mapperId);
}
var getTimestamp = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/core.ts (50:7)";
  _f.__worklet = true;
  return _f;
}();
var workletValueSetter = function () {
  ...
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/core.ts (58:7)";
  _f.__worklet = true;
  return _f;
}();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "addRouteBuilder": () => (/* reexport safe */ _routeManager__WEBPACK_IMPORTED_MODULE_4__.addRouteBuilder),
/* harmony export */   "genRouteConfig": () => (/* reexport safe */ _routeManager__WEBPACK_IMPORTED_MODULE_4__.genRouteConfig),
/* harmony export */   "getRouteBuilder": () => (/* reexport safe */ _routeManager__WEBPACK_IMPORTED_MODULE_4__.getRouteBuilder),
/* harmony export */   "removeRouteBuilder": () => (/* reexport safe */ _routeManager__WEBPACK_IMPORTED_MODULE_4__.removeRouteBuilder),
/* harmony export */   "getTimestamp": () => (/* reexport safe */ _core__WEBPACK_IMPORTED_MODULE_0__.getTimestamp),
/* harmony export */   "makeMutable": () => (/* reexport safe */ _core__WEBPACK_IMPORTED_MODULE_0__.makeMutable),
/* harmony export */   "makeRemote": () => (/* reexport safe */ _core__WEBPACK_IMPORTED_MODULE_0__.makeRemote),
/* harmony export */   "makeShareable": () => (/* reexport safe */ _core__WEBPACK_IMPORTED_MODULE_0__.makeShareable),
/* harmony export */   "requestFrame": () => (/* reexport safe */ _core__WEBPACK_IMPORTED_MODULE_0__.requestFrame),
...
/* harmony export */   "startMapper": () => (/* reexport safe */ _core__WEBPACK_IMPORTED_MODULE_0__.startMapper),
/* harmony export */   "stopMapper": () => (/* reexport safe */ _core__WEBPACK_IMPORTED_MODULE_0__.stopMapper),
/* harmony export */   "workletValueSetter": () => (/* reexport safe */ _core__WEBPACK_IMPORTED_MODULE_0__.workletValueSetter),
/* harmony export */   "createAnimatedStyle": () => (/* reexport safe */ _Hooks__WEBPACK_IMPORTED_MODULE_1__.createAnimatedStyle),
/* harmony export */   "derived": () => (/* reexport safe */ _Hooks__WEBPACK_IMPORTED_MODULE_1__.derived),
/* harmony export */   "shared": () => (/* reexport safe */ _Hooks__WEBPACK_IMPORTED_MODULE_1__.shared),
/* harmony export */   "cancelAnimation": () => (/* reexport safe */ _animations__WEBPACK_IMPORTED_MODULE_2__.cancelAnimation),
/* harmony export */   "decay": () => (/* reexport safe */ _animations__WEBPACK_IMPORTED_MODULE_2__.decay),
/* harmony export */   "decorateAnimation": () => (/* reexport safe */ _animations__WEBPACK_IMPORTED_MODULE_2__.decorateAnimation),
/* harmony export */   "defineAnimation": () => (/* reexport safe */ _animations__WEBPACK_IMPORTED_MODULE_2__.defineAnimation),
/* harmony export */   "delay": () => (/* reexport safe */ _animations__WEBPACK_IMPORTED_MODULE_2__.delay),
/* harmony export */   "initialUpdaterRun": () => (/* reexport safe */ _animations__WEBPACK_IMPORTED_MODULE_2__.initialUpdaterRun),
/* harmony export */   "repeat": () => (/* reexport safe */ _animations__WEBPACK_IMPORTED_MODULE_2__.repeat),
/* harmony export */   "sequence": () => (/* reexport safe */ _animations__WEBPACK_IMPORTED_MODULE_2__.sequence),
/* harmony export */   "spring": () => (/* reexport safe */ _animations__WEBPACK_IMPORTED_MODULE_2__.spring),
/* harmony export */   "timing": () => (/* reexport safe */ _animations__WEBPACK_IMPORTED_MODULE_2__.timing),
/* harmony export */   "transform": () => (/* reexport safe */ _animations__WEBPACK_IMPORTED_MODULE_2__.transform),
/* harmony export */   "transformAnimation": () => (/* reexport safe */ _animations__WEBPACK_IMPORTED_MODULE_2__.transformAnimation),
/* harmony export */   "Easing": () => (/* reexport safe */ _Easing__WEBPACK_IMPORTED_MODULE_3__.Easing),
/* harmony export */   "initializeReanimated": () => (/* reexport safe */ _startup__WEBPACK_IMPORTED_MODULE_5__.initializeReanimated),
/* harmony export */   "getWorkletAPI": () => (/* binding */ getWorkletAPI)
/* harmony export */ });
/* harmony import */ var _core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./core */ "./src/reanimated/core.ts");
...
/* harmony import */ var _routeManager__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./routeManager */ "./src/reanimated/routeManager.ts");
/* harmony import */ var _startup__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./startup */ "./src/reanimated/startup.ts");
...
function getWorkletAPI() {
  return {
    runOnJS: _core__WEBPACK_IMPORTED_MODULE_0__.runOnJS,
    runOnUI: _core__WEBPACK_IMPORTED_MODULE_0__.runOnUI,
    shared: _Hooks__WEBPACK_IMPORTED_MODULE_1__.shared,
    derived: _Hooks__WEBPACK_IMPORTED_MODULE_1__.derived,
    createAnimatedStyle: _Hooks__WEBPACK_IMPORTED_MODULE_1__.createAnimatedStyle,
    cancelAnimation: _animations__WEBPACK_IMPORTED_MODULE_2__.cancelAnimation,
    delay: _animations__WEBPACK_IMPORTED_MODULE_2__.delay,
    repeat: _animations__WEBPACK_IMPORTED_MODULE_2__.repeat,
    sequence: _animations__WEBPACK_IMPORTED_MODULE_2__.sequence,
    spring: _animations__WEBPACK_IMPORTED_MODULE_2__.spring,
    timing: _animations__WEBPACK_IMPORTED_MODULE_2__.timing,
    decay: _animations__WEBPACK_IMPORTED_MODULE_2__.decay,
    Easing: _Easing__WEBPACK_IMPORTED_MODULE_3__.Easing,
    addRouteBuilder: _routeManager__WEBPACK_IMPORTED_MODULE_4__.addRouteBuilder,
    removeRouteBuilder: _routeManager__WEBPACK_IMPORTED_MODULE_4__.removeRouteBuilder
  };
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "setUserGestureInProgress": () => (/* binding */ setUserGestureInProgress),
...
var RouteObject = {};
function setUserGestureInProgress() {
  RouteObject.userGestureInProgress = (0,_Hooks__WEBPACK_IMPORTED_MODULE_0__.shared)(false);
}

var createRouteContext = function () {
  var skylinePageId = (0,_Hooks__WEBPACK_IMPORTED_MODULE_0__.shared)(0);
  var skylineWindowId = (0,_Hooks__WEBPACK_IMPORTED_MODULE_0__.shared)(0);
  var primaryAnimation = (0,_Hooks__WEBPACK_IMPORTED_MODULE_0__.shared)(1);
  var primaryAnimationStatus = (0,_Hooks__WEBPACK_IMPORTED_MODULE_0__.shared)(AnimationStatus.completed);
  var secondaryAnimation = (0,_Hooks__WEBPACK_IMPORTED_MODULE_0__.shared)(1);
  var secondaryAnimationStatus = (0,_Hooks__WEBPACK_IMPORTED_MODULE_0__.shared)(AnimationStatus.completed);
  var userGestureInProgress = RouteObject.userGestureInProgress;
  ...
  var startUserGesture = function () {
    ...
    _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/route.ts (44:2)";
    _f.__worklet = true;
    return _f;
  }();
  ...
  var stopUserGesture = function () {
    ...
    _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/route.ts (50:2)";
    _f.__worklet = true;
    return _f;
  }();
  ...
  var didPop = function () {
    ...
    _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/route.ts (56:2)";
    _f.__worklet = true;
    return _f;
  }();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "addRouteBuilder": () => (/* binding */ addRouteBuilder),
/* harmony export */   "removeRouteBuilder": () => (/* binding */ removeRouteBuilder),
/* harmony export */   "getRouteBuilder": () => (/* binding */ getRouteBuilder),
/* harmony export */   "genRouteConfig": () => (/* binding */ genRouteConfig)
/* harmony export */ });
...
function addRouteBuilder(routeType, func) {
  routeBuilders.set(routeType, func);
}

function removeRouteBuilder(routeType) {
  routeBuilders.delete(routeType);
}

function getRouteBuilder(routeType) {
  return routeBuilders.get(routeType);
}

function genRouteConfig(routeType) {
  var builder = getRouteBuilder(routeType);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initializeReanimated": () => (/* binding */ initializeReanimated)
/* harmony export */ });
/* harmony import */ var _core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./core */ "./src/reanimated/core.ts");
/* harmony import */ var _route__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./route */ "./src/reanimated/route.ts");


function initializeReanimated() {
  wxNativeConsole.info('WABaseLib.Critical initializeReanimated ');
  (0,_route__WEBPACK_IMPORTED_MODULE_1__.setUserGestureInProgress)();
  SkylineGlobal.ReanimatedModule.installCoreFunctions(_core__WEBPACK_IMPORTED_MODULE_0__.workletValueSetter);
  ...
  var printLog =  true || 0;
  (0,_core__WEBPACK_IMPORTED_MODULE_0__.runOnUI)(function () {
    var _f = function () {
      var consoleOnUI = {};
      ...
      logMethods.forEach(function (method) {
        consoleOnUI[method] = printLog ? function (...args) {
          ...
          (0,_core__WEBPACK_IMPORTED_MODULE_0__.runOnJS)(capturableConsole[method]).apply(null, argumentList);
        } : function () {};
      });
    ...
    _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/startup.ts (19:10)";
    _f.__worklet = true;
    return _f;
  }())();
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "genWrapperProperty": () => (/* binding */ genWrapperProperty)
/* harmony export */ });
var genWrapperProperty = function () {
  var _f = function (prop) {
    return `_wx_internal_${prop}_`;
  };

  _f._closure = {};
  _f.asString = "function _f(prop){return`_wx_internal_${prop}_`;}";
  _f.__workletHash = 619743931776;
  _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/reanimated/util.ts (1:34)";
  _f.__worklet = true;
  return _f;
}();
...
/* harmony import */ var _webEvent__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./webEvent */ "./src/runtime/webEvent.ts");
/* harmony import */ var _reanimated_Hooks__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../reanimated/Hooks */ "./src/reanimated/Hooks.ts");
/* harmony import */ var _utils_emitter__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utils/emitter */ "./src/utils/emitter.ts");
/* harmony import */ var _reanimated__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../reanimated */ "./src/reanimated/index.ts");
/* harmony import */ var _components_worklet_event_handler__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../components/worklet_event_handler */ "./src/components/worklet_event_handler.ts");
...
if (typeof wxNativeConsole === 'undefined') {
  globalThis.wxNativeConsole = console;
}
...
class RuntimeCore {
  constructor() {
    ...
    this.anyContextEmitter = (0,_utils_emitter__WEBPACK_IMPORTED_MODULE_7__.createManyEmitter)();
    ...
    if (typeof __wxConfig === 'object' && __wxConfig.platform === 'devtools') {
      this.listenMouse();
    }
    ...
    globalThis.__runtimeCore = this;
    this.exparser.addGlobalErrorListener(function (error, info) {
      wxNativeConsole.error('[Skyline] ' + info.message);
    });
    this.exparser.addGlobalWarningListener(function (msg) {
      wxNativeConsole.warn('[Skyline] ' + msg);
    });
  }

  notifyNavigateTo(id, routeType = '', isTab = false) {
    RuntimeCore.nativeGlobal.Navigator.notifyNavigateTo(0, id);
    var routeConfig = (0,_reanimated__WEBPACK_IMPORTED_MODULE_8__.genRouteConfig)(routeType);
    var routeConfigId = routeConfig ? SkylineGlobal.Runtime.registerJsValue(routeConfig) : 0;
    this.setPageInfo(id, {
      windowId: 0,
      pageId: id,
      openType: 'navigateTo',
  ...
  windowReady(windowId) {
    ...
    return _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()(function* () {
      ...
      if (_this2.windowEmitter[windowId] === undefined) {
        _this2.windowEmitter[windowId] = (0,_utils_emitter__WEBPACK_IMPORTED_MODULE_7__.createOnceEmitter)();
      }
  ...
  pageReady(id) {
    ...
    return _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()(function* () {
      ...
      wxNativeConsole.warn('[SkylineJS] wait for contextReady, id=' + id);
      ...
      if (pageInfo.isTab) {
        wxNativeConsole.warn('[SkylineJS] update tabBarWindow');
      ...
      wxNativeConsole.warn('[SkylineJS] emit contextReady ' + id);
      return Promise.resolve(context);
    })();
  }

  getTabBarContext() {
    wxNativeConsole.warn('[SkylineJS] getTabBarContext tabBarWindow: ', this.tabBarWindow);

    if (typeof this.tabBarWindow === 'undefined') {
  ...
  detachCustomRoute(id) {
    ...
    mapperIds.forEach(function (id) {
      SkylineGlobal.ReanimatedModule.stopMapper(id);
    });
  ...
  initTabBar(element) {
    ...
    context.startRender(function () {
      wxNativeConsole.log('initTabBar done');
    });
  }
  ...
  dispatchTransitionEvent(evt) {
    if (this.isInterceptingEvent()) {
      wxNativeConsole.log(`[SkylineJS] intercepted event ${evt.type}`);
      this.eventInterceptor(evt);
    } else {
      (0,_webEvent__WEBPACK_IMPORTED_MODULE_5__.dispatchTransitionEvent)(evt);
    }
  }
  ...
  dispatchTouchEvent(evt) {
    if (this.isInterceptingEvent()) {
      ...
      (0,_webEvent__WEBPACK_IMPORTED_MODULE_5__.dispatchTouchEvent)(evt);
    }
  }
  ...
  dispatchMouseEvent(evt) {
    if (this.isInterceptingEvent()) {
      ...
      (0,_webEvent__WEBPACK_IMPORTED_MODULE_5__.dispatchMouseEvent)(evt);
    }
  }
  ...
  listenMouse() {
    ...
    SkylineGlobal.Runtime.registerMouseCallback(function (evt) {
      _this5.dispatchMouseEvent(evt);
    });
  }
  ...
  listenTransition() {
    ...
    SkylineGlobal.Runtime.registerTransitionCallback(function (evt) {
      _this6.dispatchTransitionEvent(evt);
    });
  }
  ...
  useCustomRoute(id) {
    ...
    var routeConfigId = pageInfo.data.routeConfigId;
    return routeConfigId > 0;
  }
  ...
  attachCustomRoute(id, hostNode) {
    ...
    var rConfig = SkylineGlobal.Runtime.getJsValueById(routeConfigId);
    var mapperIds = [];
    var workletHandlers = [];
    ...
    var addWorkeltEventHandler = function (eventName, worklet) {
      if (typeof worklet !== 'function') return;
      var handler = new _components_worklet_event_handler__WEBPACK_IMPORTED_MODULE_9__.default(worklet, eventName);
    ...
    addWorkeltEventHandler(eventName, function () {
      ...
      _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/runtime/index.ts (376:38)";
      _f.__worklet = true;
      return _f;
    }());
    ...
    addWorkeltEventHandler(secondaryEventName, function () {
      ...
      _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/runtime/index.ts (385:47)";
      _f.__worklet = true;
      return _f;
    }());
    workletHandlers.forEach(function (handler) {
    ...
    var addAnimatedStyle = function (updater) {
      ...
      var style = (0,_reanimated_Hooks__WEBPACK_IMPORTED_MODULE_6__.createAnimatedStyle)(updater);
    ...
    var updateAnimationController = function () {
      ...
      _f.__location = "/Users/huangningyuan/Documents/skyline3/src/skyline-js/src/runtime/index.ts (407:38)";
      _f.__worklet = true;
      return _f;
    }();

    var inputs = Object.values(updateAnimationController._closure);
    var mapperId = SkylineGlobal.ReanimatedModule.startMapper(updateAnimationController, inputs, []);
    ...
    wxNativeConsole.info(`[skyline] pageId: ${id} isNewEngineHomePage: ${pageInfo.isNewEngineHomePage}`);
  }

  startTouchEventInterception(interceptor) {
    if (this.eventInterceptor) {
      wxNativeConsole.log('[SkylineJS] already intercepting touch event, ignoring start request');
      return;
    }
  ...
  stopTouchEventInterception() {
    if (!this.eventInterceptor) {
      wxNativeConsole.log('[SkylineJS] not intercepting touch event, ignoring stop request');
      return;
    }
  ...
  isInterceptingEvent() {
    return typeof this.eventInterceptor === 'function';
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "dispatchTouchEvent": () => (/* binding */ dispatchTouchEvent),
/* harmony export */   "dispatchTransitionEvent": () => (/* binding */ dispatchTransitionEvent),
/* harmony export */   "dispatchMouseEvent": () => (/* binding */ dispatchMouseEvent)
/* harmony export */ });
...
var touchstartX = 0;
var touchstartY = 0;
var TAP_MOVE_DELTA = 10;

var triggerTouchEvent = function (evt, evtName = "", requireActive = false, relatedInfo = undefined) {
  var exparser = (_lib_exparser__WEBPACK_IMPORTED_MODULE_0___default());
  exparser.triggerEvent(evt.target, evtName || evt.type, {}, {
    bubbles: true,
    capturePhase: true,
    composed: true,
    extraFields: {
...
var handleTrackStart = function (evt) {
  if (touchstartTs) return;
  if (evt.touches.length !== 1) return;
  touchstartTs = evt.timeStamp;
  touchstartX = evt.touches[0].pageX;
  touchstartY = evt.touches[0].pageY;
};

var handleTrackMove = function (evt) {
  if (!touchstartTs) return;
  if (evt.touches.length !== 1) return;
  var x = evt.touches[0].pageX;
  var y = evt.touches[0].pageY;

  if (!(Math.abs(x - touchstartX) < TAP_MOVE_DELTA && Math.abs(y - touchstartY) < TAP_MOVE_DELTA)) {
    console.info('trigger canceltap');
    triggerTouchEvent(evt, "canceltap", true);
    touchstartTs = 0;
  }
};

var handleTrackEnd = function (evt) {
  if (!touchstartTs) return;
  touchstartTs = 0;
};

function dispatchTouchEvent(evt) {
  if (evt.type === 'touchstart') {
    handleTrackStart(evt);
  ...
  trace("Exparser", "dispatchEvent", function (finishTrace) {
    wrapTapMark(evt.type, function () {
      triggerTouchEvent(evt);
      finishTrace();
    });
  });
}

var construstDetail = function (e) {
  return {
...
function dispatchTransitionEvent(evt) {
  var exparser = (_lib_exparser__WEBPACK_IMPORTED_MODULE_0___default());
  exparser.triggerEvent(evt.target, evt.type, construstDetail(evt), {
    bubbles: true,
    capturePhase: true,
    composed: true,
    extraFields: {}
...
function dispatchMouseEvent(evt) {
  var exparser = (_lib_exparser__WEBPACK_IMPORTED_MODULE_0___default());
  exparser.triggerEvent(evt.target, evt.type, {}, {
    bubbles: true,
    capturePhase: true,
    composed: true,
    extraFields: {}
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _example_transition__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./example/transition */ "./src/example/transition.ts");
/* harmony import */ var _reanimated__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./reanimated */ "./src/reanimated/index.ts");


(0,_reanimated__WEBPACK_IMPORTED_MODULE_1__.initializeReanimated)();
(0,_example_transition__WEBPACK_IMPORTED_MODULE_0__.default)();
})();
